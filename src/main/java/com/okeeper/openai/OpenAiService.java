...
import com.okeeper.openai.api.OpenAiError;
import com.okeeper.openai.api.OpenAiHttpException;
...
import com.okeeper.openai.api.image.CreateImageEditRequest;
import com.okeeper.openai.api.image.CreateImageRequest;
import com.okeeper.openai.api.image.CreateImageVariationRequest;
...
public class OpenAiService {
    ...
    public OpenAiService(final String token, final Duration timeout) {
        ...
        this.okHttpClient = defaultClient(token, timeout);
    }
