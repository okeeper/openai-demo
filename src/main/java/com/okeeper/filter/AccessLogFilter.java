...
public class AccessLogFilter extends HttpFilter {
	...
	protected void doFilter(HttpServletRequest req, HttpServletResponse res, FilterChain chain) throws IOException, ServletException {
		...
		ContentCachingRequestWrapper cachingRequestWrapper = new ContentCachingRequestWrapper(req, 10240);
		...
		LOGGER.info("{} {} {} , status={}, cost={}, requestBody={}, responseBody={}", method, requestUri, queryParam, status, end - start, requestBody, responseBody);
